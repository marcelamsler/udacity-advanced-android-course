...
public class SettingsActivity extends PreferenceActivity
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        } else if (key.equals(getString(R.string.pref_units_key)) || key.equals(getString(R.string.pref_art_pack_key))) {
            // units or artpack has changed. update lists of weather entries accordingly
            getContentResolver().notifyChange(WeatherContract.WeatherEntry.CONTENT_URI, null);
        } else if(key.equals(getString(R.string.location_status_key))) {
